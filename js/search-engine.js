(function() {
        ...
        noticias: [
            {
                ...
                keywords: ['corte', 'tráfico', 'san donato', 'fiestas', 'calles', 'avenida']
            },
            {
                id: 'n2',
                type: 'bando',
                ...
                keywords: ['programa', 'fiestas', 'san donato', 'conciertos', 'actividades']
            },
            {
                id: 'n3',
                type: 'bando',
                ...
                keywords: ['tratamiento', 'moscas', 'mosquitos', 'fumigación', 'sanidad', 'plagas']
            },
            {
                id: 'n4',
                type: 'noticia',
                ...
                keywords: ['música', 'escuela', 'inscripción', 'cultura', 'clases']
            },
            {
                id: 'n5',
                type: 'bando',
                ...
                keywords: ['desbroce', 'parcelas', 'limpieza', 'terrenos', 'solares', 'vallado']
            }
        ],
        ordenanzas: [
            {
                ...
                pdfUrl: '#',
                pdfContent: 'Artículo 1 Objeto alcance limpieza viaria recogida residuos sólidos urbanos Artículo 2 Definiciones residuos domésticos comerciales industriales Artículo 3 Obligaciones ciudadanos depositar basuras contenedores apropiados horarios establecidos',
                keywords: ['limpieza', 'residuos', 'basuras', 'contenedores', 'reciclaje', 'recogida']
            },
            {
                id: 'o2',
                type: 'ordenanza',
                ...
                url: 'tramites.html#ordenanzas',
                pdfUrl: '#',
                pdfContent: 'Artículo 1 Naturaleza hecho imponible titularidad vehículos motor Artículo 2 Cuotas tarifas según potencia fiscal cilindrada Artículo 3 Bonificaciones vehículos históricos eléctricos híbridos Artículo 4 Período impositivo devengo',
                keywords: ['impuesto', 'vehículos', 'IVTM', 'coches', 'motos', 'tasas', 'pago']
            },
            {
                id: 'o3',
                type: 'ordenanza',
                ...
                pdfUrl: '#',
                pdfContent: 'Título I Disposiciones generales ámbito aplicación Título II Clasificación calificación suelo urbano urbanizable rústico Título III Régimen edificación condiciones construcción alturas máximas retranqueos Título IV Licencias urbanísticas obras mayores menores Título V Protección legalidad urbanística inspección sanciones',
                keywords: ['urbanismo', 'planeamiento', 'licencias', 'obras', 'construcción', 'edificación', 'solares']
            },
            {
                id: 'o4',
                type: 'ordenanza',
                ...
                keywords: ['vallado', 'limpieza', 'solares', 'desbroce', 'cerramiento', 'terrenos']
            }
        ],
        institucional: [
            {
                ...
                keywords: ['alcalde', 'manuel lópez', 'saludo', 'bienvenida', 'transparencia']
            },
            {
                id: 'i2',
                type: 'pagina',
                ...
                keywords: ['equipo', 'gobierno', 'concejales', 'alcalde', 'delegaciones']
            },
            {
                id: 'i3',
                type: 'pagina',
                ...
                keywords: ['biblioteca', 'horarios', 'préstamo', 'libros', 'internet', 'wifi']
            },
            {
                id: 'i4',
                type: 'pagina',
                ...
                keywords: ['castillo', 'historia', 'medieval', 'patrimonio', 'turismo', 'visitas']
            },
            {
                id: 'i5',
                type: 'pagina',
                ...
                keywords: ['contratante', 'licitaciones', 'contratos', 'adjudicaciones', 'transparencia']
            }
        ],
        plenos: [
            {
                ...
                keywords: ['pleno', 'sesión', 'presupuesto', 'ordenanzas', 'acta']
            },
            {
                id: 'p2',
                type: 'pleno',
                ...
                keywords: ['pleno', 'extraordinario', 'presupuestos', 'debate', 'aprobación']
            }
        ],
        servicios: [
            {
                ...
                keywords: ['sanidad', 'salud', 'médicos', 'centro salud', 'citas', 'urgencias']
            },
            {
                id: 's2',
                type: 'servicio',
                ...
                date: '2024-01-01',
                url: 'servicios.html#urbanismo',
                keywords: ['urbanismo', 'licencias', 'obras', 'construcción', 'planeamiento']
            },
            {
                id: 's3',
                type: 'servicio',
                ...
                keywords: ['protección civil', 'emergencias', '112', 'seguridad']
            }
        ],
        tramites: [
            {
                ...
                keywords: ['sede electrónica', 'trámites', 'online', 'certificado', 'registro']
            },
            {
                id: 't2',
                type: 'tramite',
                ...
                keywords: ['empadronamiento', 'padrón', 'certificado', 'domicilio']
            }
        ]
    };
    ...
    function calculateRelevance(item, normalizedQuery, queryWords) {
        ...
        // Palabras en contenido principal
        queryWords.forEach(word => {
    ...
    function search(query, filters = {}) {
        ...
        Object.keys(searchIndex).forEach(category => {
            searchIndex[category].forEach(item => {
                ...
                const relevance = calculateRelevance(item, normalizedQuery, queryWords);
    ...
    function handleSearchSubmit(e) {
        ...
        if (query.length >= 2) {
            ...
            if (currentPath.includes('/ayuntamiento/') || currentPath.includes('/tramites/')) {
    ...
    function init() {
        ...
        // Formulario de búsqueda - IMPORTANTE: remover el alert
